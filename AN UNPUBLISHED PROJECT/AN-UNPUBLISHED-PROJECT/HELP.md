...
* The original package name 'MODULITH-SERVICES.AN UNPUBLISHED PROJECT' is invalid and this project uses 'MODULITH_SERVICES.AN.UNPUBLISHED.PROJECT' instead.
...
* [Getting Started with Distributed Tracing](https://docs.spring.io/spring-boot/4.0.8-SNAPSHOT/reference/actuator/tracing.html)
...
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/4.0.8-SNAPSHOT/reference/data/nosql.html#data.nosql.redis)
* [SpringDoc OpenAPI](https://springdoc.org/)
* [OAuth2 Client](https://docs.spring.io/spring-boot/4.0.8-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
* [WebSocket](https://docs.spring.io/spring-boot/4.0.8-SNAPSHOT/reference/messaging/websockets.html)
* [OpenTelemetry](https://docs.spring.io/spring-boot/4.0.8-SNAPSHOT/reference/actuator/observability.html#actuator.observability.opentelemetry)
